...
export default function ItemPositive({ cat, index }) {
  return (
    <div key={index} className="group transition bg-black bg-opacity-25 rounded border border-teal-900 hover:border-teal-600 hover:shadow-lg overflow-hidden">
      ...
      <div className="grid grid-cols-3 gap-2 py-2 px-4">
        ...
        <div>
          ...
          <span className="text-xs text-teal-400 truncate flex gap-1 items-center bg-teal-900 bg-opacity-20 rounded">
