...
export default function ItemPositive({ cat, index }) {
  return (
    <div key={index} className="group transition bg-black bg-opacity-25 rounded overflow-hidden">
      <div className="text-teal-100 bg-gradient-to-tr from-teal-800 to-teal-600 px-4 pt-6 pb-4 border-t-2 border-teal-400">
        <svg viewBox="0 0 140 140" className="stroke-current h-5 w-5 transform -rotate-90" xmlns="http://www.w3.org/2000/svg">
