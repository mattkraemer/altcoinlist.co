...
export default function ItemNegative({ cat, index }) {
  return (
    <div key={index} className="group transition bg-black bg-opacity-25 rounded border border-gray-800 hover:border-red-900 hover:shadow-lg overflow-hidden">
      <header className="py-2 px-4 bg-black bg-opacity-25 flex justify-between items-center">
        ...
        <span className="rounded-full h-3 w-3 bg-red-600 border-2 border-red-400 opacity-50 group-hover:opacity-100 group-hover:animate-pulse" />
      </header>
