    ...
    <div className="container mx-auto">
      {
        ...
        <div className="flex">
          <div className="m-auto my-20 text-gray-400 text-opacity-50 bg-black bg-opacity-10 rounded-xl p-12">
            <svg className="h-16 w-16 stroke-current text mx-auto mb-4" viewBox="0 0 140 140" xmlns="http://www.w3.org/2000/svg">
      ...
      }
      {
        ...
        <div className="flex">
          <div className="m-auto my-20 text-gray-44 text-opacity-50 bg-black bg-opacity-10 rounded-xl p-12">
            <svg className="h-16 w-16 stroke-current text mx-auto mb-4 animate-spin" viewBox="0 0 140 140" xmlns="http://www.w3.org/2000/svg">
